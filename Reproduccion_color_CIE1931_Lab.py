...
im_Lab= fun.ReproduccionCie1931(imagenes_patron,selec_imagenes=combinaciones[numero_imagenes-1],OutColorSpace="Lab")

fun.imshow('Reproducción CIE 1931',im_Lab,InColorSpace="Lab")

fun.imwrite('Resultados/Imagenes/Reprocucion_Nim_'+str(12)+'.png',im_Lab,InColorSpace="Lab")
...
fun.imwrite('Resultados/Imagenes/Correcion_Linear_Nim_'+str(12)+'.png',im_Lab_Linear,InColorSpace="Lab")
...
im_Lab_Polynomial,Ccm_Polynomial = fun.CCM_Polynomial(im_Lab, color_Lab_pixel_ideal, mascaras)
fun.imshow('Imagen mejorada mediante ccm Polynomial', im_Lab_Polynomial,InColorSpace="Lab")
fun.imwrite('Resultados/Imagenes/Correcion_Polynomial_Nim_'+str(12)+'.png',im_Lab_Polynomial,InColorSpace="Lab")
