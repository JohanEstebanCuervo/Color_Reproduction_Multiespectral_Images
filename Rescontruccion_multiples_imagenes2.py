...
im_RGB= fun.ReproduccionCie1931(imagenes_patron[:-2]/255,selec_imagenes=combinaciones[5])
...
fun.Write_Variable('CCM_Linear_Nim7', Ccm_linear)
...
fun.Write_Variable('CCM_Compound_Nim7', Ccm_Compound)
...
fun.Write_Variable('CCM_Logarithm_Nim7', Ccm_Logarithm)
...
fun.Write_Variable('CCM_Polynomial_Nim7', Ccm_Polynomial)
...
#%% Red neuronal2
red = keras.models.load_model('Resultados/Variables/Correction_color_neuronal_red_Nim7.h5')
...
fun.comparacion_color_check('CIE 1931 utililizando 7 espectros', im_RGB, color_check, mascaras,carpeta='Resultados/Imagenes')
fun.comparacion_color_check('Polynomial utililizando 7 espectros', im_RGB5, color_check, mascaras,carpeta='Resultados/Imagenes')
fun.comparacion_color_check('red utililizando 7 espectros', im_RGB6, color_check, mascaras,carpeta='Resultados/Imagenes')
