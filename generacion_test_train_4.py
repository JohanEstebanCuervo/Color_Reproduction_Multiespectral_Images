...
for combinacion in range(10):
    for grupo in entrenamiento:
        ...
        im_RGB = fun.ReproduccionCie1931(
            imagenes_patron, selec_imagenes=combinaciones[combinacion]
        )
    ...
    df.to_csv(
        "Resultados/Datos_entrenamiento/Datos_train_Nim4_comb" + str(combinacion) + ".csv",
        header=None,
        index=False,
    )
    ...
    df.to_csv(
        "Resultados/Datos_entrenamiento/Datos_test_Nim4_comb" + str(combinacion) + ".csv",
        header=None,
        index=False,
    )

fun.Write_Variable("test_4_im", test)
fun.Write_Variable("train_4_im", entrenamiento)
